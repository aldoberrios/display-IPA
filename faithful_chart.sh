...
echo "    Clicks      Voi. Impl.     Ejectives   |                                    "
echo "| ʘ Bilabial  | ɓ Bilabial | ’  Examples   |          Front  Centr     Back     "
echo "| ǀ Dental    | ɗ Dent/Alv | p’ Bilabial   |   Close  i•y --- ɨ•ʉ --- ɯ •u      "
echo "| ǃ Pos. alv  | ʄ Palatal  | t’ Dent/Alv.  |            \ ɪ ʏ   \  ʊ    |       "
echo "| ǂ Pal. alv  | ɠ Velar    | k’ Velar      |   Clmid    e•ø --- ɘ•ɵ -- ɤ•o      "
echo "| ǁ Alv. lat  | ʛ Uvular   | s’ Alv. Fric. |              \      ə      |       "
echo "                                               Opmid      ɛ•œ -- ɜ•ɞ - ʌ•ɔ      "
echo "                                                            æ      ɐ    |       "
echo "                                               Open          a•ɶ ----- ɑ•ɒ      "
echo ""
echo "                                               Where symbos appear in pairs,    "
echo "                                               the one to the right represents  "
echo "                                               a rounded vowel.                 "
